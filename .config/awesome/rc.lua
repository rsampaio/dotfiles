...
picon = awful.widget.launcher({
  ...
  command = "sudo pacman -Sy && echo -e 'vicious.force({ pacup, })' | awesome-client"
})
...
for s = 1, screencount do
  ...
  if screencount ~= 2 then
    ...
    mybottomwibox[s] = awful.wibox({ position = "bottom", screen = s, border_width = 0, height = 20, bg = beautiful.bottom_bg })
...
globalkeys = awful.util.table.join(awful.key({ modkey, }, "Left", awful.tag.viewprev),
  ...
  -- awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn("backlight + b") end),
  -- awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn("backlight - b") end),
  -- awful.key({ }, "XF86KbdBrightnessUp", function () awful.util.spawn("backlight + k") end),
  -- awful.key({ }, "XF86KbdBrightnessDown", function () awful.util.spawn("backlight - k") end),
